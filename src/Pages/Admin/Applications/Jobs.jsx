...
const Jobs = () => {
  ...
  const { data, loading, refresh } = useGet(`/api/admin/jobs?page=${page}&limit=10&search=${search}`);
    ...
    <div className="p-6 max-w-[1600px] mx-auto w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">Manage jobs for recruitment applications</p>
        </div>
